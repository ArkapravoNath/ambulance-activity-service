...
@RestController
@RequestMapping("/api/ambulanceactivityservice-kafka")
public class AmbulanceactivityserviceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(AmbulanceactivityserviceKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public AmbulanceactivityserviceKafkaResource(KafkaProperties kafkaProperties) {
